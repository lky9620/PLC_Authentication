...
#define GetB0(A)  ( (INT8U)((A)    ) )
#define GetB1(A)  ( (INT8U)((A)>> 8) )
#define GetB2(A)  ( (INT8U)((A)>>16) )
#define GetB3(A)  ( (INT8U)((A)>>24) )
...
{
    INT32U L0, L1, R0, R1;       // Iuput/output values at each rounds
    INT32U T0, T1;               // Temporary variables for round function F
    INT32U* K = pdwRoundKey;     // Pointer of round keys

// Set up input values for first round
    L0 = ((INT32U)pbData[3] << 24) | ((INT32U)pbData[2] << 16) | ((INT32U)pbData[1] << 8) | ((INT32U)pbData[0]);
    L1 = ((INT32U)pbData[7] << 24) | ((INT32U)pbData[6] << 16) | ((INT32U)pbData[5] << 8) | ((INT32U)pbData[4]);
    R0 = ((INT32U)pbData[11] << 24) | ((INT32U)pbData[10] << 16) | ((INT32U)pbData[9] << 8) | ((INT32U)pbData[8]);
    R1 = ((INT32U)pbData[15] << 24) | ((INT32U)pbData[14] << 16) | ((INT32U)pbData[13] << 8) | ((INT32U)pbData[12]);
    ...
    pbData[0] = (INT8U)((R0) & 0xFF);
    pbData[1] = (INT8U)((R0 >> 8) & 0xFF);
    pbData[2] = (INT8U)((R0 >> 16) & 0xFF);
    pbData[3] = (INT8U)((R0 >> 24) & 0xFF);

    pbData[4] = (INT8U)((R1) & 0xFF);
    pbData[5] = (INT8U)((R1 >> 8) & 0xFF);
    pbData[6] = (INT8U)((R1 >> 16) & 0xFF);
    pbData[7] = (INT8U)((R1 >> 24) & 0xFF);

    pbData[8] = (INT8U)((L0) & 0xFF);
    pbData[9] = (INT8U)((L0 >> 8) & 0xFF);
    pbData[10] = (INT8U)((L0 >> 16) & 0xFF);
    pbData[11] = (INT8U)((L0 >> 24) & 0xFF);

    pbData[12] = (INT8U)((L1) & 0xFF);
    pbData[13] = (INT8U)((L1 >> 8) & 0xFF);
    pbData[14] = (INT8U)((L1 >> 16) & 0xFF);
    pbData[15] = (INT8U)((L1 >> 24) & 0xFF);
}
...
{
    INT32U A, B, C, D;               // Iuput/output values at each rounds
    INT32U T0, T1;                   // Temporary variable
    INT32U* K = pdwRoundKey;         // Pointer of round keys

// Set up input values for Key Schedule
    A = ((INT32U)pbUserKey[3] << 24) | ((INT32U)pbUserKey[2] << 16) | ((INT32U)pbUserKey[1] << 8) | ((INT32U)pbUserKey[0]);
    B = ((INT32U)pbUserKey[7] << 24) | ((INT32U)pbUserKey[6] << 16) | ((INT32U)pbUserKey[5] << 8) | ((INT32U)pbUserKey[4]);
    C = ((INT32U)pbUserKey[11] << 24) | ((INT32U)pbUserKey[10] << 16) | ((INT32U)pbUserKey[9] << 8) | ((INT32U)pbUserKey[8]);
    D = ((INT32U)pbUserKey[15] << 24) | ((INT32U)pbUserKey[14] << 16) | ((INT32U)pbUserKey[13] << 8) | ((INT32U)pbUserKey[12]);
