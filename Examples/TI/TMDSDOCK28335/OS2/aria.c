 ...
 *
 * Note:
 *    - Now we use the following longerface:
 *      void Crypt(const Byte *plalongext, long numberOfRounds, const Byte *roundKeys, Byte *cipherText);
 *      long EncKeySetup(const Byte *masterKey, Byte *roundKeys, long keyBits);
 *      long DecKeySetup(const Byte *masterKey, Byte *roundKeys, long keyBits);
...
void RotXOR(const Byte* s, long n, Byte* t)
{
    long i, q;
