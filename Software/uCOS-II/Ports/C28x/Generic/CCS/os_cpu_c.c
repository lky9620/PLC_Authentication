...
void OSTaskSwHook(void)
{
    ...
    extern INT8U DEVICE_OUT[2];
    TaskID;
    OSTime;
//    __asm("   ESTOP0");

if(TaskID !=0 && init_flag==1){
        Excute_Time = OSTime-Time;
        Time = OSTime;
        DEVICE_OUT[0] = TaskID;
        DEVICE_OUT[1] = Excute_Time;
...
//    if (TaskID != 0){
//        Task_Seq[cnt0++] = TaskID;
//        Time_Seq[cnt1++] = OSTime>>8;
//        Time_Seq[cnt1++] = OSTime&0xff;
//    }
//
//
//    DEVICE_OUT[3] = 12;//OSCPUUsage;
